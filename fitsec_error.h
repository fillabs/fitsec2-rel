...
#define FSERR_AT_REQUEST                FSERR_CONTAINER_BIT(AT_REQUEST)

#define FSERR_CONTAINERS_SHIFT (_FSERR_SIZEOF-_FSERR_EL_MAX_VALUE)

#define FSERR_ELEMENT(err) ((err & (0xFFFFFFFF >> FSERR_CONTAINERS_SHIFT))>>FSERR_ELEMENTS_SHIFT)
